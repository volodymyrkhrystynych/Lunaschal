...
#### Study — see [`backend/study/CLAUDE.md`](backend/study/CLAUDE.md) for the sources (PDF / archived web page / YouTube), why the large-screen gate is not Piano's `desktopOnly`, and how the notes half reuses the Notebook editor. Staged build plan (only Stage 1 is built): [docs/study-tab.md](docs/study-tab.md)
