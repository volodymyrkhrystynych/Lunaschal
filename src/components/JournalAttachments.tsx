 ...
 *
 * Collapsed by default — an entry with a voice memo should still read as an
 * entry, not as a media gallery — and everything inside it is opt-in: the
 * transcript/caption is only produced when asked for, because on this hardware
 * it costs a real CPU transcription or a model swap.
 *
...
function AttachmentRow({
  ...
  return (
    <details className="rounded border border-white/10 bg-white/5">
      <summary className="px-3 py-2 text-sm text-[var(--color-text)] cursor-pointer select-none flex items-center gap-2">
