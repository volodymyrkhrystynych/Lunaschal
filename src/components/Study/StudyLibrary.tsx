...
export function StudyLibrary({ onOpen }: Props) {
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {isLoading ? (
          ...
          <div className="text-[var(--color-text-muted)] max-w-prose">
            Nothing here yet. Upload a book, archive a web page, or pull down a
            YouTube video — then it opens beside a notebook page you write in.
          </div>
        ) : (
              ...
              <li key={source.id}>
                <div className="w-full flex items-center gap-3 px-3 py-2 rounded hover:bg-white/5 group">
                  <button
                    ...
                    disabled={source.importStatus !== 'ready'}
                  ...
                  <button
                    ...
                    className="px-2 py-0.5 rounded text-[var(--color-text-muted)] opacity-0 group-hover:opacity-100 hover:bg-white/10 hover:text-red-400"
                  >
                    ✕
                  </button>
                </div>
