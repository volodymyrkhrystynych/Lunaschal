...
export function Reader({ ficId, initialChapterId, onBack }: ReaderProps) {
  ...
  useEffect(() => {
    ...
    const lastRead =
      fic.lastReadChapterId &&
      chapters.find(c => c.id === fic.lastReadChapterId);
  ...
  return (
    <div className="flex-1 flex overflow-hidden">
      ...
      {!isPdf && navVisible && (
        <aside
          data-reader-nav
          className="w-64 border-r border-white/10 bg-[var(--color-surface)] flex flex-col shrink-0"
        >
          <div className="p-3 border-b border-white/10">
            ...
            <div className="mt-1 font-semibold text-[var(--color-text)] leading-snug">
              {fic?.title}
            </div>
            {fic?.author && (
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
              ...
              {chapters && chapters.length === 0 ? (
                ...
                <>
                  ...
                  <div className="text-sm text-[var(--color-text-muted)] mb-6 flex gap-3">
                    ...
                    {fontSize !== READING_FONT_SIZE_DEFAULT && (
        ...
        <div className="border-t border-white/10 bg-[var(--color-surface)]">
          ...
          >
            ...
            {commentarySaved && (
              <span className="ml-2 text-green-400">saved to journal ✓</span>
            )}
          </button>
          {showCommentary && (
