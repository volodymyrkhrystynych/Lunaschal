...
def create_app():
    ...
    from backend.routes import journal, calendar, flashcard, settings, rag, chat, files, writing, stt, tasks
    from backend.routes import auth as auth_routes
    for bp in (auth_routes.bp, journal.bp, calendar.bp, flashcard.bp, settings.bp, rag.bp, chat.bp, files.bp, writing.bp, stt.bp, tasks.bp):
