...
def create_app():
    ...
    from backend.routes import journal, calendar, flashcard, settings, rag, chat, files, writing, stt, tasks, curated_tags, shortcuts, voice_command, transcriptions, cookbook
    ...
    for bp in (auth_routes.bp, journal.bp, calendar.bp, flashcard.bp, settings.bp, rag.bp, chat.bp, files.bp, writing.bp, stt.bp, tasks.bp, curated_tags.bp, shortcuts.bp, voice_command.bp, transcriptions.bp, cookbook.bp):
